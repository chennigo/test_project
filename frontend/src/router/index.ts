    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'system-warehouses',
          component: () => import('../views/system/WarehouseListView.vue'),
        ...
        },
        {
          path: 'stock/check',
          name: 'stock-check',
          component: () => import('../views/stock/StockCheckView.vue'),
        ...
        },
        {
          path: 'stock/transfer',
          name: 'stock-transfer',
          component: () => import('../views/stock/TransferListView.vue'),
        ...
        },
        {
          path: 'reports',
          name: 'reports',
          component: () => import('../views/report/ReportsHubView.vue'),
          meta: { title: '报表中心', roles: ['admin', 'finance'] },
        },
        {
          path: 'alerts',
          name: 'alerts',
          component: () => import('../views/report/LowStockView.vue'),
